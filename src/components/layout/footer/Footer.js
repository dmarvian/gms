						...
						<div className="col-12">
							<div className="copyright-content-area">
								<div className="footer-contact">
									<ul>
										<li>
											<Link href="tel:02159582830">
												<span className="icon">
													<i className="tji-phone-2"></i>
												</span>
												<span className="text">(021) 59582830</span>
											</Link>
										</li>
										<li>
											<Link href="mailto:operasional@gunturmandalasakti.com">
												<span className="icon">
													<i className="tji-envelop-2"></i>
												</span>
												<span className="text">operasional@gunturmandalasakti.com</span>
											</Link>
										</li>
									</ul>
								</div>
